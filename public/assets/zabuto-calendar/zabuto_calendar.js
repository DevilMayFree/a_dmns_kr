...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $currMonthLabel = $('<span>' + year +
            '년 ' + monthLabels[month] + '</span>');
            ...
            var $monthHeaderRow = $('<tr class="calendar-month-header" data-year="' + year + '" data-month="' + monthLabels[month] + '"></tr>');
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var $dayElement = $('<a href="javascript:" id="' + dayId + '" class="day attendDate" data-date="' + dateAsString(year, month, currDayOfMonth) + '" onClick="chgAttendDate(event);">' + currDayOfMonth + '</a>');
